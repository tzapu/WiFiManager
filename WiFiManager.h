...
class WiFiManager
{
  public:
    ...
    //called when client has connected to the AP portal
	void          setAPClientConnectedCallback( void (*func)(WiFiManager*) );
	//called when client has disconnected from the AP portal
	void          setAPClientDisconnectedCallback( void (*func)(WiFiManager*) );
  ...
  private:
	...
	void (*_apClientConnectedCallback)(WiFiManager*) = NULL;
	void (*_apClientDisconnectedCallback)(WiFiManager*) = NULL;
