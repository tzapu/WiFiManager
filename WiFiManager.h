...
const char HTTP_ITEM[] PROGMEM = "<div><a href='#wmform' onclick='c(this)'>{v}</a>&nbsp;<span class='q {i}'>{r}%</span></div>";
...
const char HTTP_FORM_START[] PROGMEM = "<form id='wmform' method='get' action='wifisave'><input id='s' name='s' length=32 placeholder='SSID'><br/><input id='p' name='p' length=64 type='password' placeholder='password'><br/>";
