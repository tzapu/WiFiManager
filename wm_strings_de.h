...
"<form action='/wifi'    method='get'><button>WiFi Konfiguration</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>WiFi Konfiguration ohne SSID Scan</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Informationen</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Parameterkonfiguration</button></form><br/>\n",//MENU_PARAM
...
"<form action='/erase'   method='get'><button class='D'>WiFi Konfiguration löschen und Neustart</button></form><br/>\n", // MENU_ERASE
"<form action='/update'  method='get'><button>Neue Firmware hochladen</button></form><br/>\n",// MENU_UPDATE
"<hr><br/>" // MENU_SEP
};
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Kennwort</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' onclick='f()'> Kennwort anzeigen";
...
const char HTTP_UPDATEBTN[]        PROGMEM = "<br/><form action='/update' method='get'><button>Firmwareaktualisierung</button></form>";
const char HTTP_BACKBTN[]          PROGMEM = "<hr><br/><form action='/' method='get'><button>Zurück</button></form>";

const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Verbunden</strong> zu{v}<br/><em><small>mit IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Nicht verbunden</strong> zu {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Authentikationsfehler"; // STATION_WRONG_PASSWORD,  no eps32
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>SSID nicht gefunden";   // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>Verbindungsaufbau fehlgeschlagen"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Keine SSID konfiguriert</div>";
...
const char HTTP_UPDATE_FAIL[] PROGMEM = "<div class='msg D'><strong>Firmware hochladen fehlgeschlagen!</strong><Br/>Restarte das Gerät und versuche es noch einmal</div>";
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Firmware erfolgreich hochgeladen.</strong> <br/>Gerät wird jetzt neugestartet...</div>";
