...
const char S_resetting[]          PROGMEM = "O dispositivo reinicirár dentro de segundos.";
const char S_closing[]            PROGMEM = "Pode fechar a página, o portal continurár a funcionar";
