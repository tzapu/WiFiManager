...
const char HTTP_SCAN_LINK[]        PROGMEM = "<br/><form action='/wifi?refresh=1' method='POST'><button name='refresh' value='1'>Refresh</button></form><br/><form action='/' method='get'><button>Atrás</button></form>";
